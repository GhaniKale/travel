            ...
            <div className="max-w-7xl mx-auto">
                <div className="relative rounded-3xl overflow-hidden cta-gradient p-12 md:p-20">
                    <div className="relative z-10 max-w-xl">
                        ...
                        <button className="bg-white text-secondary px-10 py-4 rounded-xl font-headline font-bold text-lg shadow-xl shadow-black/10 hover:scale-105 transition-transform">
                            Claim This Offer
                        </button>
                    </div>
                    <div className="absolute right-0 top-0 h-full w-full md:w-1/2 opacity-30 md:opacity-100 mix-blend-overlay">
